...
```{r rename}
NCAA_full_set <- rename(NCAA_full_set,c("Rank_Ace"="Rank.x",
                                        "Team_Name"="Team",
                                        "N/A"="S.x",
                                        "Aces"="Aces",
                                        "Per_Set_x"="Per Set.x",
