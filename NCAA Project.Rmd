...
ace_pf<-powerTransform(ace_lm, family="bcnPower")
summary(ace_pf)

ace_trans<-lm(log(Win_Percentage+.1)~Aces, data = NCAA_full_set)
...
assists_trans<-lm(log(Win_Percentage+.1)~Assists, data = NCAA_full_set)
...
block_solo_trans<-lm(Win_Percentage~Block_Solos, data = NCAA_full_set)

block2_plot = ggplot(aes(x = Block_Solos,y = Win_Percentage),data = NCAA_full_set) +
  geom_point() +
  geom_smooth(method = "lm")
block2_plot
...
block_assists_trans<-lm(log(Win_Percentage+.1)~Block_Assists, data = NCAA_full_set)

block_assists_plot2 = ggplot(aes(x = Block_Assists, y = log(Win_Percentage)), data = NCAA_full_set) +
  geom_point() +
  geom_smooth(method = "lm")
block_assists_plot2
...
triple_block_trans<-lm(log(Win_Percentage+.1)~Triple_Block, data = NCAA_full_set)

triple_block_plot2 = ggplot(aes(x = Triple_Block, y = log(Win_Percentage)), data = NCAA_full_set) +
  geom_point() +
  geom_smooth(method = "lm")
triple_block_plot2
...
digs_trans<-lm(log(Win_Percentage+.1)~Digs, data = NCAA_full_set)
